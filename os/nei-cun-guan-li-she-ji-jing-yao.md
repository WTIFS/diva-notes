...
![table-of-content](../OS/assets/2021-02-28-16145096642881-table-of-content.png)
...
![bump-allocator](../OS/assets/2021-02-28-16145096642924-bump-allocator.png)

根据线性分配器的原理，我们可以推测它有较快的执行速度，以及较低的实现复杂度；但是线性分配器无法在内存被释放时重用内存。如下图所示，如果已经分配的内存被回收，线性分配器是无法重新利用红色的这部分内存的：

![bump-allocator-reclaim-memory](../OS/assets/2021-02-28-16145096642930-bump-allocator-reclaim-memory.png)
...
![free-list-allocator](../OS/assets/2021-02-28-16145096642935-free-list-allocator.png)
