...
然后到服务器上配置一下，在程序崩溃时生成 core 文件。[dlv core](https://github.com/go-delve/delve/blob/master/Documentation/usage/dlv_core.md) 目前只支持 Linux 和 Windows 系统。Linux 配置如下：
